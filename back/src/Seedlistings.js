...
const sampleListings = [
  {
    ...
    amenities: ['Fiber WiFi', 'Breakfast included', 'Courtyard', 'Air conditioning'],
  ...
  },
  {
    ...
    amenities: ['Guided tours', 'Traditional dinner included', 'Campfire', 'Star gazing'],
  ...
  },
  {
    ...
    amenities: ['Sea View Terrace', 'Full kitchen', 'Parking', 'Air conditioning', 'In-unit washer'],
    bookingPreferences: { instantBook: true },
  ...
  },
  {
    ...
    amenities: ['Rooftop terrace', 'Fiber WiFi', 'Espresso machine'],
  ...
  },
  {
    ...
    amenities: ['Courtyard', 'Breakfast included', 'Parking', 'Full kitchen'],
  ...
  },
  {
    ...
    amenities: ['Camel trekking', 'Traditional dinner included', 'Campfire'],
    bookingPreferences: { instantBook: false, advanceNoticeHours: 48 },
  ...
  },
  {
    ...
    amenities: ['Fiber WiFi', 'Air conditioning', 'Balcony', 'Elevator'],
    bookingPreferences: { instantBook: true },
  ...
  },
  {
    ...
    amenities: ['Rooftop terrace', 'Breakfast included', 'Fiber WiFi'],
    bookingPreferences: { instantBook: false },
